...
$lang['Text in the image'] = 'Texte dans l\'image';
$lang['Show text contained in the image'] = 'Afficher le texte contenu dans l\'image';
$lang['Hide text contained in the image'] = 'Masquer le texte contenu dans l\'image';
...
$lang['Display AI descriptions in the gallery'] = 'Afficher les descriptions IA dans la galerie';
$lang['Enable to display AI-generated descriptions after the regular photo description.'] = 'Activez pour afficher les descriptions générées par l\'IA à la suite de la description habituelle des photos.';
$lang['Description prefix'] = 'Préfixe de description';
$lang['Optional text displayed before AI-generated descriptions.'] = 'Texte optionnel affiché avant les descriptions générées par l\'IA.';
$lang['Allow Piwigo AI to create new tags'] = 'Autoriser Piwigo AI à créer de nouveaux tags';
$lang['Disable to reuse existing tags only.'] = 'Désactivez pour réutiliser uniquement les tags existants.';
...
$lang['<div>You are running in degraded mode because your database version (%s) is below the required version (MariaDB 11.8.2+). Some Piwigo AI features are not available. <a id="p_ai_check_compatibility" href="#">Recheck compatibility</a></div>'] = '<div>Piwigo AI fonctionne en mode dégradé car votre version de base de données (%s) est inférieure à la version requise (MariaDB 11.8.2+). Certaines fonctionnalités ne sont pas disponibles. <a id="p_ai_check_compatibility" href="#">Revérifier la compatibilité</a></div>';
$lang['Contextual tagging requires MariaDB 11.8.2 or newer.'] = 'Le tagging contextuel nécessite MariaDB 11.8.2 ou une version plus récente.';
$lang['Unable to convert legacy embedding columns to MariaDB vectors without losing data.'] = 'Impossible de convertir les anciennes colonnes d’embedding en vecteurs MariaDB sans perdre de données.';
...
$lang['Photos analyzed'] = 'Photos analysées';
$lang['Pending tickets'] = 'Tickets en attente';
$lang['Failed tickets'] = 'Tickets échoués';
$lang['Recently analyzed'] = 'Récemment analysées';
$lang['See all tickets'] = 'Voir tous les tickets';
$lang['AI Server'] = 'Serveur IA';
$lang['Connected'] = 'Connecté';
$lang['Usage'] = 'Utilisation';
$lang['Current session'] = 'Session actuelle';
$lang['Resets in'] = 'Réinitialisation dans';
$lang['No expiration'] = 'Sans expiration';
$lang['Credit usage'] = 'Consommation de crédits';
