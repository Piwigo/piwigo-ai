  ...
  <div class="piwigoai m-5 pb-16 flex gap-10">
    <div class="flex flex-col items-start text-start space-y-4">
      <p>
        ...
        <span class="font-bold text-sm p-1.25">{'Credits owned'|translate}</span>
      </p>

      <div class="mt-5 flex flex-col p-3 bg-[#FAFAFA] rounded-xl w-105 h-64 shadow-lg">
    ...
    <div class="flex flex-col items-start text-start space-y-4">
      <p>
        ...
        <span class="font-bold text-sm p-1.25">{'Buy credits'|translate}</span>
      </p>
